...
def extract_faculty_info(faculty_page):
    ...
    email = fac_info_container.find('a', {'href': re.compile(r'mailto:')}).get_text(
        strip=True) if fac_info_container.find('a', {'href': re.compile(r'mailto:')}) else "Not Available"
    phone = fac_info_container.find('p', class_='phoneicon').get_text(strip=True) if fac_info_container.find('p',
                                                                                                             class_='phoneicon') else "Not Available"
