To begin collaboration, first successfully pull the repository. Ensure you run pip install flask on your terminal as well as pip install flask-cors to avoid any CORS errors on the webpage
